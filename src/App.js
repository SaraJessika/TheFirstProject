...
//Вот класс для отправления запросов на сервер, но не могу его поднлючить через React
/*class DataSet{
    constructor(options){
        this.options = {
...
/*Не могу соедининть два объекта в функции App
* Пользовалась Create-React_app
* использовала команду npx create-react-app my-app для последней версии Node.js
*/
export default App;